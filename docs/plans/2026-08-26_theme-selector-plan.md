...
- [ ] Update README theme documentation, run `npm run ci`, `npm run test:e2e`, and `git diff --check`, review the final diff, and update PR #18.
...
- [ ] All automated checks pass and PR #18 is updated with successful CI.
